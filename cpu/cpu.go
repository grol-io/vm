...
// sysRead, sysRead8, sysWrite8, sysWrite are in platform-specific files:
// cpu_io_unix.go (uses syscall.Read/Write directly - fast)
// cpu_io_windows.go (uses os.NewFile - required for Windows Handle compatibility)
